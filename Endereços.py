...
if authenticator_status:
    ...
    st.markdown(f'[![Foo](https://upload.wikimedia.org/wikipedia/commons/thumb/6/6b/WhatsApp.svg/50px-WhatsApp.svg.png)](https://api.whatsapp.com/send?text="{str(endereco_unidade["UNIDADE:"][0])}{str(endereco_unidade["CEP:"][0])}")')

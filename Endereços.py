...
if authenticator_status:
    ...
    st.markdown(f'[![Foo](https://upload.wikimedia.org/wikipedia/commons/thumb/6/6b/WhatsApp.svg/50px-WhatsApp.svg.png)](https://wa.me/send?text="{nome_unidade}2%{end_unidade})')
